...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Imam_Arslan\\Desktop\\JavaMasterClass_Udemy\\Databases\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_ARTIST_START =
...
//    albums.name, songs.track;
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " + TABLE_ARTIST_SONG_VIEW +
            ...
            "." + COLUMN_SONG_TITLE + " FROM " + TABLE_SONGS + " INNER JOIN " + TABLE_ALBUMS + " ON " +
            TABLE_SONGS + "." + COLUMN_SONG_ALBUM + " = " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ID +
            " INNER JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + " = " +
    ...
    private int insertArtist(String name) throws SQLException
    {
        ...
        if(results.next())
            return results.getInt(1); // artist already exists, so return his id
    ...
    public void insertSong(String title, String artist, String album, int track)
    {
        try {
            ...
            if(results.next()) // song already exist
            {
                System.out.println("Song already exists within database!");
                return;
            }
